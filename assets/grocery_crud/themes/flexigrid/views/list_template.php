...
<div class="flexigrid box box-bordered" style='width: 100%;' data-unique-hash="<?php echo $unique_hash; ?>">
	...
	<div>
		...
		<div class="tDiv3 btn-group">
			<?php if(!$unset_export) { ?>
        	<a class="export-anchor btn btn-lightgrey" data-url="<?php echo $export_url; ?>" target="_blank">
				<i class="icon-table"></i><?php echo $this->l('list_export');?></span>
            </a>
			<?php } ?>
			<?php if(!$unset_print) { ?>
        	<a class="print-anchor btn btn-lightgrey" data-url="<?php echo $print_url; ?>">
	...
	<?php }?>
	<?php echo form_open( $ajax_list_url, 'method="post" id="filtering_form1" class="filtering_form" autocomplete = "off" data-ajax-list-info-url="'.$ajax_list_info_url.'"'); ?>
	<div class="pDiv">
		<div class="pDiv2">
			<div class="pGroup">
	...
	<div class="sDiv quickSearchBox" id='quickSearchBox'>
        ...
        <div class='search-div-clear-button'>
        	<input type="button" value="<?php echo $this->l('list_clear_filtering');?>" id='search_clear' class="search_clear btn btn-inverse">
        </div>
	</div>
	<div class="pDiv">
		<div class="pDiv2">
