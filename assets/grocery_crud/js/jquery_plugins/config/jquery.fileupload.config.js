            ...
            send: function(e, data) {
                ...
                if (typeof data.result.success != 'undefined' && data.result.success) {
                    ...
                    $.each(data.result.files, function(index, file) {
                        ...
                        var is_image = (file_name.toLowerCase().substr(-4) == '.jpg' || file_name.toLowerCase().substr(-4) == '.png' || file_name.toLowerCase().substr(-5) == '.jpeg' || file_name.toLowerCase().substr(-4) == '.gif' || file_name.toLowerCase().substr(-5) == '.tiff') ? true : false;
                        //: uppercase file extension fix
                        if (is_image) {
